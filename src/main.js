...
console.log(`main | Loading started at ${(+new Date())}`);
...
bootstrap(Vue)
  ...
  .then(function bootstrapDone() {
    console.log(`main | Bootstrap completed succesfully at ${(+new Date())}`);
  ...
  .catch((error) => { // eslint-disable-line no-unused-vars
    console.error('main | Error occured while bootstrap, ', error);
